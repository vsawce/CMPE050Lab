...
public:
	...
	// Assignment operator
	friend Polynomial operator+(const Polynomial &polya, const Polynomial &polyb); //poly + poly
	friend Polynomial operator+(const double num, const Polynomial &pola); //const + poly
	friend Polynomial operator+(const Polynomial &pola, const double num); //poly + const
	friend Polynomial operator-(const Polynomial &polya, const Polynomial &polyb); //poly - poly
	friend Polynomial operator-(const double num, const Polynomial &pola); //const - poly
	friend Polynomial operator-(const Polynomial &pola, const double num); //poly - const
	friend Polynomial operator*(const Polynomial &polya, const Polynomial &polyb); //poly * poly
